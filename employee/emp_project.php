...
$data8 = mysqli_query($conn, "SELECT * FROM task WHERE deptm='$deptm' AND `upload_date`='1000-01-01' AND (`member` LIKE '%$nm%' || `leader` LIKE '%$nm%');");
...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            ...
            <form action="emp_project_load.php" method="POST" id="formx" enctype="multipart/form-data">
                <div class="hx1">
                    <label for="pro_name">Project Name</label>
                    <select name="pro_name" id="" required>
                        <?php
                        if ($total96 = mysqli_num_rows($data8) > 0) {
                            $w = 0;

                            while ($result96 = mysqli_fetch_array($data8)) {
                        ?>
                    ...
                    <input type="text" name="description" id="n1" placeholder="Enter Description of the project" required>
                </div>
                <div class="hx2">
                    ...
                    ?>
                            <input value="<?php echo $result['name']; ?>" name="submitted" readonly="readonly">
                            <input value="<?php echo $result['deptm']; ?>" name="submittedby" readonly="readonly" style="display:none;">
                    <?php
                            $i++;
                        }
                    } else {
                    ...
                    <input type="file" name="file" id="n2" required accept=".pdf,.zip">
                </div>
            ...
            <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                <thead>
                    <tr class="bg-dark" style="text-align: center;">
                        <th>SL.</th>
                        <th>Project Name</th>
                        <th>Description</th>
                        <th>Submitted By</th>

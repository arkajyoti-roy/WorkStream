...
$data3 = mysqli_query($conn, "SELECT * FROM task WHERE `deptm`= '$deptm' ORDER BY id DESC;");
?>
    ...
    <section class="dashboard">
        <div class="top">
            ...
            <div class="search-box">
                <input type="text" required style="border-color: #fff;" readonly>
            </div>
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">Task Assigned to Department</span>
                </div>
            </div>
        </div>
        <table class="table">
        ...
        <iframe src="man_task_adm.php" height="400px" width="98%" frameborder="0" ; style="border: 1.5px navy solid; border-radius:7px"></iframe>





        <div class="dash-content" style="margin-top: -71px;">
            <div class="overview">
                <div class="title">
        ...
        <h3 style=" margin-left: 25px; margin-bottom: -29px; color: var(--text-color); font-size: 20px;">Create Task</h3>
        <form action="man_task_ass.php" method="POST" class="m1" style=" color: var(--text-color);">
            <div id="alt1">
                <label for="deptm">Department</label>
                <select name="deptm" id="n3" required>
                    <?php
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    <i class="uil uil-check"></i>
                    <span class="text">Task Assigned to Employee</span>
                </div>

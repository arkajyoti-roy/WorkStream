...
$data2 = mysqli_query($conn, "SELECT * FROM `leave` WHERE status = 'Pending' ORDER BY id DESC;");
$data3 = mysqli_query($conn, "SELECT * FROM `leave` WHERE status = 'Approved' ORDER BY id DESC;");
    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="leave.php">
                        <i class="uil uil-user-minus" style="color: blue;"></i>
                        <span class="link-name" style="color: blue;">Leave</span>
                    </a></li>
                    ...
                    <tbody>
                        <div class="">
                            ...
                            ?>
                                    ...
                                    <tr style="text-align: center;" id="<?php echo $result2['name']; ?>">
                                        ...
                                        <td style="font-size: 11px;"> <?php echo $result2['specify']; ?> </td>
                                        <td style="color:navy;"> <a href="<?php echo $result2['img']; ?>" download> file</a> </td>
                                        ...
                                        <td>
                                            <form action="leave_approve.php" method="post">
                                                <input type="text" name="j1" style="display: none;" value="<?php echo $result2['id']; ?>">
                                                <button class="vibrant-y">Confirm</button>
                                            </form>
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">Approved Leave Requests</span>
                </div>
                        ...
                        <div class="">
                            ...
                            ?>
                                    ...
                                    <tr class="" style="text-align: center;">
                                        ...
                                        <td> <?php echo date('d-M-Y', strtotime($result3['start_date'])); ?> </td>

                                        <td> <?php echo date('d-M-Y', strtotime($result3['last_date'])); ?> </td>
